...
const faqStaticData = [{id: 1, question: 'What should do at first as a student?', answer: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci eum expedita incidunt laborum libero nemo nisi.'}, {
    id: 2,
...
}, {id: 3, question: 'Is it essential for the team leader to create a team?', answer: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci eum expedita incidunt laborum libero nemo nisi. Ab amet eligendi ipsam ipsum, mollitia nisi quaerat repudiandae ullam? Consequuntur quidem sed tempora.'}, {
    id: 4,
    question: 'How to find a supervisor and co-supervisor for the research?',
    answer: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci eum expedita incidunt laborum libero nemo nisi. Ab amet eligendi ipsam ipsum, mollitia nisi quaerat repudiandae ullam? Consequuntur quidem sed tempora.'
}, {
    id: 5,
            ...
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="max-w-2xl lg:mx-auto lg:text-center">
                    ...
                    <p className="mt-4 text-gray-500">
                        Refer the FAQ section below to resolve any issues you may have.
                    </p>
                </div>
                <div className="mt-20">
