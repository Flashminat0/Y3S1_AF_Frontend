...
const BaseChatWrapper = ({
                             children, selectedPageIndex, selectedType, dataID, hoveringUserId,
                         }) => {
                                        ...
                                        <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                                            ...
                                            >
                                                <div className="px-2 space-y-1">
                                                    {navigation.map((item, index) => (<div key={index}>
                                                        <motion.div
                                                            whileHover={{
                                                                scale: 1.05,
                                                            }}
                                                        ...
                                                        >
                                                                            <span
                                                                                ...
                                                                                className={classNames(selectedPageIndex === index ? 'bg-gray-100 text-gray-900 font-normal ' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900', 'group flex items-center px-2 py-2 text-base font-medium rounded-md no-underline cursor-pointer')}
                                                                            >
                                                                                <item.icon
                                                                                    className={classNames(selectedPageIndex === index ? 'text-gray-500' : 'text-gray-400 group-hover:text-gray-500', 'mr-4 h-8 w-8')}
                                                                                    aria-hidden="true"
                                                                                />
                                                                                {item.name}
                                                                            </span>
                        ...
                        <aside
                            ...
                            <div className="absolute inset-0 py-6 px-4 sm:px-6 lg:px-8">
                                <div className="h-full border-2 border-gray-200 border-dashed rounded-lg">
                                    {selectedType}
                                    {dataID}
                                    {hoveringUserId && (<div>{hoveringUserId}</div>)}
                                </div>
                            </div>
