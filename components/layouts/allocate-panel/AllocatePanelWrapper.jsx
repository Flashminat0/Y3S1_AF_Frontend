...
const AllocatePanelWrapper = ({children, btnFunction}) => {
    return (
        <div className={'px-6 py-6 grid grid-cols-1 gap-3'}>
            <GreenFullButton btnName={'Allocate Panel'} btnFunction={btnFunction}/>
            <div className={'px-3 py-2 my-5 bg-gray-100 shadow rounded-lg'}>
                <div className={'flex flex-row justify-between items-center'}>
                    <div className={'flex flex-col gap-4'}>
                        ...
                        <div className={'flex flex-row gap-2 sm:gap-5 lg:gap-20 items-center'}>
                    ...
                    <div className={'pr-2 sm:pr-8'}>
                        <MdGroups className={'w-20 h-20 sm:w-24 sm:h-24 text-gray-600'}/>
                    </div>
                </div>
            </div>
            {children}
