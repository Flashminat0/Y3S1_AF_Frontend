            ...
            <div className={"px-3 py-2 my-5 bg-gray-100 shadow rounded-lg"}>
                <div className={"flex flex-row justify-between items-center"}>
                    <div className={"flex flex-col gap-4"}>
                        <div>
                            <div className={"uppercase text-2xl font-semibold"}>Research Topic</div>
                        ...
                        <div className={"flex flex-row gap-52 items-center"}>
                            ...
                            <div className={"flex flex-col"}>
                                ...
                                <div className={"flex flex-row gap-2"}>
                                    <div className={"text-xs text-gray-500"}>Anne Venroy (IT20453793),</div>
                                    <div className={"text-xs text-gray-500"}>Martha Checkus (IT20216770),</div>
                                    <div className={"text-xs text-gray-500"}>Nichola Shenel (IT20154052),</div>
                                </div>
                            </div>
                        </div>
                    </div>
